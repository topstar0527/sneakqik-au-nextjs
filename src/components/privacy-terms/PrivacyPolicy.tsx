...
const PrivacyPolicy = () => {
  return (
    <>
      <Typography>
        <p>
          Your privacy is important to us at SneakQIK. We respect your privacy and are commited to protecting the
          privacy of your data. This Privacy Policy describes Our policies and procedures on the collection, use and
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Site </strong> (referred to as either &quot;Website&quot;, &quot;We&quot;, &quot;Us&quot; or
              &quot;Our&quot; in this Agreement) refers to SneakQIK accessible from{" "}
              <a href="https://sneakqik.com" target="_blank" rel="external nofollow noopener noreferrer">
                https://sneakqik.com
              </a>
            </p>
          </li>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: New South Wales, Australia
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Service</strong> refers to the services our Site provides.
            </p>
          </li>
          <li>
            <p>
              <strong>Service Provider</strong> means any natural or legal person who processes the data on behalf of
              the Site. It refers to third-party companies or individuals employed by the Site to facilitate the
              Service, to provide the Service on behalf of the Site, to perform services related to the Service or to
              assist the Site in analyzing how the Service is used.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>You</strong> means the individual accessing or using the Service, or the Site, or other legal
        ...
        <ul>
          ...
          <li>
            <p>Your business/brand information</p>
          </li>
          <li>
            <p>Usage Data</p>
          </li>
        ...
        <p>
          The Site may use Personal Data for the following purposes:
          <br />
          <br />
        </p>
        <ul>
          ...
          <li>
            ...
            purchase contract for the products, items or services You have purchased via Our site or of any other
          ...
          <li>
            ...
            services and events which we offer that are similar to those that you have already purchased via Our site or
        ...
        <ul>
          ...
          <li>
            <strong>With Payment Providers:</strong> We may share Your personal information with Payment Providers to
            monitor and analyze the use of our Service, to contact You.
          </li>
          <li>
            <strong>For Business transfers:</strong> We may share or transfer Your personal information in connection
            with, or during negotiations of, any merger, sale of Site assets, financing, or acquisition of all or a
            portion of our business to another Site.
          </li>
          <li>
            <strong>With Affiliates:</strong> We may share Your information with Our affiliates, in which case we will
            require those affiliates to honor this Privacy Policy. Affiliates include Our parent Site and any other
        ...
        <p>
          The Site will retain Your Personal Data only for as long as is necessary for the purposes set out in this
          Privacy Policy. We will retain and use Your Personal Data to the extent necessary to comply with our legal
          obligations (for example, if we are required to retain your data to comply with applicable laws), resolve
          disputes, and enforce our legal agreements and policies.
        </p>
        <p>
          The Site will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a
        ...
        <p>
          Your information, including Personal Data, is processed at the Site&apos;s operating offices and in any other
        ...
        <p>
          The Site will take all steps reasonably necessary to ensure that Your data is treated securely and in
        ...
        <p>
          If the Site is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will
        ...
        <p>
          Under certain circumstances, the Site may be required to disclose Your Personal Data if required to do so by
        ...
        <p>The Site may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
          <li>Comply with a legal obligation</li>
          <li>Protect and defend the rights or property of the Siite</li>
        ...
        <p>
          ...
          for payment processing (e.g. payment processors). We will not store or collect Your payment card details. That
          information is provided directly to Our third-party payment processors whose use of Your personal information
          is governed by their Privacy Policy. These payment processors adhere to strict industry standards that help
        ...
        <p>
          This privacy policy was last updated on October 7, 2020. We may update our Privacy Policy from time to time.
          We reserve the right, at Our sole discretion, to modify or replace the Privacy Policy at any time.
        </p>

        <p>
          You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are
          effective when they are posted on this page. By continuing to access or use Our Service after those revisions
          become effective, You agree to be bound by the revised Privacy Policy. If You do not agree to the new Privacy
          Policy, in whole or in part, please stop using the website and the Service.
        </p>
        <h1>
          <br />
          Contact Us
        </h1>
        <p>This site is operated by AdAvenue Media, Suite 1A Level 2 802 Pacific Highway Gordon 2072 Australia.</p>
        <p>If you have any questions about this Privacy Policy, You can contact us:</p>
        <ul>
          <li>By email: contact@sneakqik.com</li>
        </ul>
      </Typography>
    </>
  );
