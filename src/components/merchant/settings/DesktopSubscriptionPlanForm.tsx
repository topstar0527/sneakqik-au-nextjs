...
type DesktopSubscriptionPlanFormProps = {
...
const DesktopSubscriptionPlanForm: React.FunctionComponent<DesktopSubscriptionPlanFormProps> = (props) => {
  ...
  const plans = props.value === 0 ? yearlyPlans : monthlyPlans;
...
export default DesktopSubscriptionPlanForm;
