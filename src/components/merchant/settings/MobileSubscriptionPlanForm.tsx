...
type MobileSubscriptionPlanFormProps = {
  onChange: (value: number) => void;
  onSubmit: () => void;
  value: number;
};

const MobileSubscriptionPlanForm: React.FunctionComponent<MobileSubscriptionPlanFormProps> = (props) => {
...
export default MobileSubscriptionPlanForm;
